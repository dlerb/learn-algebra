...
The hard work is building and sequencing the taxonomy of expression families. The app delivers it. The taxonomy is the real product.
...
- Visible mastery indicator per expression family
- Spaced repetition for revisiting older families
